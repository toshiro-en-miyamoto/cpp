...
1. If the argument is an non-parenthesized id-expression or an non-parenthesized class member access expression, then `decltype` yields the type of the *entity* named by this expression.
