...
Then you might start writing code to implement the function. Once you done, you must ask yourself; How do you know that your function is corrent?
...
The initial test cases only test obvious boundary conditions and it happen to cover all branches including an implicit braching of the `while` loop. Are we dne? No. Recall the algorithm:
